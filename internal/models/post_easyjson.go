...
func easyjson5a72dc82DecodeGithubComBigBullasTPDBProjectInternalModels(in *jlexer.Lexer, out *Post) {
...
func easyjson5a72dc82EncodeGithubComBigBullasTPDBProjectInternalModels(out *jwriter.Writer, in Post) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != 0 {
...
func (v Post) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5a72dc82EncodeGithubComBigBullasTPDBProjectInternalModels(&w, v)
...
func (v *Post) UnmarshalJSON(data []byte) error {
	...
	easyjson5a72dc82DecodeGithubComBigBullasTPDBProjectInternalModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Post) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5a72dc82DecodeGithubComBigBullasTPDBProjectInternalModels(l, v)
}
